...
namespace UrbanFiesta.Migrations
{
    ...
    [Migration("20230519113047_AddedIsEmailForNLConf")]
    partial class AddedIsEmailForNLConf
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CitizenEvent", b =>
                {
                    ...
                    b.HasKey("LikedEventsId", "LikesId");
            ...
            modelBuilder.Entity("Entities.Models.Citizen", b =>
                {
                    ...
                    b.Property<string>("EmailForNewsletter")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("IsEmailForNewsletterConfirmed")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CitizenEvent", b =>
                {
                    ...
                    b.HasOne("Entities.Models.Citizen", null)
                        .WithMany()
